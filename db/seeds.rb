...
Currency.create(name: "GBP", dollar_conversion_rate: 0.86)
Currency.create(name: "EUR", dollar_conversion_rate: 0.98)
Currency.create(name: "JOD", dollar_conversion_rate: 0.71)
Currency.create(name: "JPY", dollar_conversion_rate: 142.50)
